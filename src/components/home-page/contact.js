    ...
    return (
        <div className='contact-content'>
            ...
            <div className="content">
                ...
                <div>
                    <picture>
                        <source data-src={require('../../assets/images/contact/min-900.png')} media='(min-width: 900px)' />
                        <source data-src={require('../../assets/images/contact/min-600.png')} media='(min-width: 600px)' />
                        <img data-src={require('../../assets/images/contact/max-599.png')} alt='chef' />
                    </picture>
