                        ...
                        <div className='slides'>
                            <div className='offer-group'>
                                <div className='offer-container'>
                                    <div>
                                        <picture>
                                            <source data-src={require('../../assets/images/offers/1/min-900.png')} media='(min-width: 900px)' />
                                            <source data-src={require('../../assets/images/offers/1/min-600.png')} media='(min-width: 600px)' />
                                            <img data-src={require('../../assets/images/offers/1/max-599.png')} alt='steak' />
                                        </picture>
                                    </div>
                                ...
                                <div className="offer-container">
                                    <div>
                                        <picture>
                                            <source data-src={require('../../assets/images/offers/2/min-900.png')} media='(min-width: 900px)' />
                                            <source data-src={require('../../assets/images/offers/2/min-600.png')} media='(min-width: 600px)' />
                                            <img data-src={require('../../assets/images/offers/2/max-599.png')} alt='burger' />
                                        </picture>
                                    </div>
                                ...
                                <div className="offer-container">
                                    <div>
                                        <picture>
                                            <source data-src={require('../../assets/images/offers/3/min-900.png')} media='(min-width: 900px)' />
                                            <source data-src={require('../../assets/images/offers/3/min-600.png')} media='(min-width: 600px)' />
                                            <img data-src={require('../../assets/images/offers/3/max-599.png')} alt='starters' />
                                        </picture>
                                    </div>
