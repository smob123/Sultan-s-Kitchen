        ...
        return (
            <div className='reservation-container'>
                ...
                <div className='reservation-content'>
                    <picture>
                        <source data-src={require('../../assets/images/reservation/min-600.png')} media='(min-width: 600px)' />
                        <img data-src={require('../../assets/images/reservation/max-599.png')} alt='table' />
                    </picture>
